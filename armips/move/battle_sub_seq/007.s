...
a001_007:
    ...
    waitmessage
    wait 0x1E
    if IF_NOTMASK, VAR_MOVE_STATUS, 0x20000, _0030
...
_0148:
    ...
    goto _02D0
_0188:
    if IF_NOTMASK, VAR_MOVE_STATUS, 0x40, _01B0
    printmessage 0x31C, 0x0, "NaN", "NaN", "NaN", "NaN", "NaN", "NaN"
    goto _02D0
_01B0:
    if IF_NOTMASK, VAR_MOVE_STATUS, 0x40000, _01E0
    printmessage 0x12, 0xB, 0x2, 0x2, "NaN", "NaN", "NaN", "NaN"
    goto _02D0
_01E0:
    if IF_NOTMASK, VAR_MOVE_STATUS, 0x8, _021C
    incrementgamestat BATTLER_ATTACKER, 0x0, 0x60
    printmessage 0x1B, 0x2, 0x2, "NaN", "NaN", "NaN", "NaN", "NaN"
    goto _02D0
_021C:
    if IF_NOTMASK, VAR_MOVE_STATUS, 0x80000, _024C
    printmessage 0x271, 0xB, 0x2, 0x2, "NaN", "NaN", "NaN", "NaN"
    goto _02D0
_024C:
    if IF_NOTMASK, VAR_MOVE_STATUS, 0x1000, _0278
    printmessage 0x156, 0x2, 0x2, "NaN", "NaN", "NaN", "NaN", "NaN"
    goto _02D0
_0278:
    getmoveparameter 0x7
    if IF_EQUAL, VAR_CALCULATION_WORK, 0x4, _02C0
    if IF_EQUAL, VAR_CALCULATION_WORK, 0x8, _02C0
...
_02D0:
    waitmessage
    wait 0x1E
    if IF_NOTMASK, VAR_SERVER_STATUS1, 0x40000, _02F8
    gotosubscript 57
_02F8:
