...
u16 move_effect_to_subscripts[] =
{
    ...
    [ADD_STATUS_EFF_SUPERPOWER_DEBUFF]           = SUB_SEQ_SUPERPOWER_DEBUFF,
    ...
    [ADD_STATUS_EFF_CLOSE_COMBAT_DEBUFF]         = SUB_SEQ_CLOSE_COMBAT_DEBUFF,
    ...
    [ADD_STATUS_EFF_QUIVER_DANCE]                = SUB_SEQ_QUIVER_DANCE,
    [ADD_STATUS_EFF_CHANGE_TARGET_TO_WATER_TYPE] = SUB_SEQ_CHANGE_TARGET_TO_WATER_TYPE,
    [ADD_STATUS_EFF_COIL]                        = SUB_SEQ_COIL,
    [ADD_STATUS_EFF_SHIFT_GEAR]                  = SUB_SEQ_SHIFT_GEAR,
    [ADD_STATUS_EFF_SHELL_SMASH]                 = SUB_SEQ_SHELL_SMASH,
